...
defined('PATH_VIEW') || define('PATH_VIEW', PATH_APP . 'views' . DS);
defined('PATH_MODEL') || define('PATH_MODEL', PATH_APP . 'models' . DS);
defined('PATH_CONTROLLER') || define('PATH_CONTROLLER', PATH_APP . 'controllers' . DS);
defined('PATH_CONFIG') || define('PATH_CONFIG', PATH_ROOT . 'core' . DS . 'config' . DS);
defined('PATH_CORE') || define('PATH_CORE', PATH_ROOT . 'core' . DS);

defined('PATH_TRANSLATIONS') || define('PATH_TRANSLATIONS', PATH_APP . 'i18n' . DS);
...
$defaultPorts = in_array(PORT, array(443, 80));//regardless the protocol
...
defined('URL_ROOT') || define('URL_ROOT', PROTOCOL . ':' . US . US . $SERVER_NAME . (($defaultPorts) ? '' : ':'.PORT). US);
...
defined('ERROR_LEVEL') || define('ERROR_LEVEL',  2<<13 -1 );
